...
// deliberately marked not-live so we do not show fake prices.
const MARKETS = Object.freeze({
  lv: { country:'LV', zone:'LV', sourceKey:'lv', live:true, currency:'EUR', timezone:'Europe/Riga', vatPct:21, addersEurPerKwh:0.16, name:{en:'Latvia',lv:'Latvija',lt:'Latvija',ee:'Läti',ru:'Латвия'}, flag:'🇱🇻', lang:'lv' },
  lt: { country:'LT', zone:'LT', sourceKey:'lt', live:true, currency:'EUR', timezone:'Europe/Vilnius', vatPct:21, addersEurPerKwh:0.16, name:{en:'Lithuania',lv:'Lietuva',lt:'Lietuva',ee:'Leedu',ru:'Литва'}, flag:'🇱🇹', lang:'lt' },
  ee: { country:'EE', zone:'EE', sourceKey:'ee', live:true, currency:'EUR', timezone:'Europe/Tallinn', vatPct:24, addersEurPerKwh:0.16, name:{en:'Estonia',lv:'Igaunija',lt:'Estija',ee:'Eesti',ru:'Эстония'}, flag:'🇪🇪', lang:'ee' },
  fi: { country:'FI', zone:'FI', sourceKey:'fi', live:true, currency:'EUR', timezone:'Europe/Helsinki', vatPct:25.5, addersEurPerKwh:0.16, name:{en:'Finland',lv:'Somija',lt:'Suomija',ee:'Soome',ru:'Финляндия'}, flag:'🇫🇮', lang:'en' },
  no1:{ country:'NO', zone:'NO1', live:false, currency:'NOK', timezone:'Europe/Oslo', vatPct:25, addersEurPerKwh:0, name:{en:'Norway NO1 Oslo',lv:'Norvēģija NO1 Oslo',lt:'Norvegija NO1 Oslas',ee:'Norra NO1 Oslo',ru:'Норвегия NO1 Осло'}, flag:'🇳🇴', lang:'en' },
  no2:{ country:'NO', zone:'NO2', live:false, currency:'NOK', timezone:'Europe/Oslo', vatPct:25, addersEurPerKwh:0, name:{en:'Norway NO2 Kristiansand',lv:'Norvēģija NO2 Kristiansand',lt:'Norvegija NO2 Kristiansand',ee:'Norra NO2 Kristiansand',ru:'Норвегия NO2 Кристиансанд'}, flag:'🇳🇴', lang:'en' },
  no3:{ country:'NO', zone:'NO3', live:false, currency:'NOK', timezone:'Europe/Oslo', vatPct:25, addersEurPerKwh:0, name:{en:'Norway NO3 Trondheim',lv:'Norvēģija NO3 Trondheim',lt:'Norvegija NO3 Trondheim',ee:'Norra NO3 Trondheim',ru:'Норвегия NO3 Тронхейм'}, flag:'🇳🇴', lang:'en' },
  no4:{ country:'NO', zone:'NO4', live:false, currency:'NOK', timezone:'Europe/Oslo', vatPct:25, addersEurPerKwh:0, name:{en:'Norway NO4 Tromsø',lv:'Norvēģija NO4 Tromsø',lt:'Norvegija NO4 Tromsø',ee:'Norra NO4 Tromsø',ru:'Норвегия NO4 Тромсё'}, flag:'🇳🇴', lang:'en' },
  no5:{ country:'NO', zone:'NO5', live:false, currency:'NOK', timezone:'Europe/Oslo', vatPct:25, addersEurPerKwh:0, name:{en:'Norway NO5 Bergen',lv:'Norvēģija NO5 Bergen',lt:'Norvegija NO5 Bergen',ee:'Norra NO5 Bergen',ru:'Норвегия NO5 Берген'}, flag:'🇳🇴', lang:'en' },
  se1:{ country:'SE', zone:'SE1', live:false, currency:'SEK', timezone:'Europe/Stockholm', vatPct:25, addersEurPerKwh:0, name:{en:'Sweden SE1 Luleå',lv:'Zviedrija SE1 Luleå',lt:'Švedija SE1 Luleå',ee:'Rootsi SE1 Luleå',ru:'Швеция SE1 Лулео'}, flag:'🇸🇪', lang:'en' },
  se2:{ country:'SE', zone:'SE2', live:false, currency:'SEK', timezone:'Europe/Stockholm', vatPct:25, addersEurPerKwh:0, name:{en:'Sweden SE2 Sundsvall',lv:'Zviedrija SE2 Sundsvall',lt:'Švedija SE2 Sundsvall',ee:'Rootsi SE2 Sundsvall',ru:'Швеция SE2 Сундсвалль'}, flag:'🇸🇪', lang:'en' },
  se3:{ country:'SE', zone:'SE3', live:false, currency:'SEK', timezone:'Europe/Stockholm', vatPct:25, addersEurPerKwh:0, name:{en:'Sweden SE3 Stockholm',lv:'Zviedrija SE3 Stokholma',lt:'Švedija SE3 Stokholmas',ee:'Rootsi SE3 Stockholm',ru:'Швеция SE3 Стокгольм'}, flag:'🇸🇪', lang:'en' },
  se4:{ country:'SE', zone:'SE4', live:false, currency:'SEK', timezone:'Europe/Stockholm', vatPct:25, addersEurPerKwh:0, name:{en:'Sweden SE4 Malmö',lv:'Zviedrija SE4 Malmö',lt:'Švedija SE4 Malmö',ee:'Rootsi SE4 Malmö',ru:'Швеция SE4 Мальмё'}, flag:'🇸🇪', lang:'en' },
  dk1:{ country:'DK', zone:'DK1', live:false, currency:'DKK', timezone:'Europe/Copenhagen', vatPct:25, addersEurPerKwh:0, name:{en:'Denmark DK1 West',lv:'Dānija DK1 Rietumi',lt:'Danija DK1 Vakarai',ee:'Taani DK1 lääs',ru:'Дания DK1 запад'}, flag:'🇩🇰', lang:'en' },
  dk2:{ country:'DK', zone:'DK2', live:false, currency:'DKK', timezone:'Europe/Copenhagen', vatPct:25, addersEurPerKwh:0, name:{en:'Denmark DK2 East',lv:'Dānija DK2 Austrumi',lt:'Danija DK2 Rytai',ee:'Taani DK2 ida',ru:'Дания DK2 восток'}, flag:'🇩🇰', lang:'en' },
  ...
  nl: { country:'NL', zone:'NL', live:false, currency:'EUR', timezone:'Europe/Amsterdam', vatPct:21, addersEurPerKwh:0, name:{en:'Netherlands',lv:'Nīderlande',lt:'Nyderlandai',ee:'Holland',ru:'Нидерланды'}, flag:'🇳🇱', lang:'en' },
  be: { country:'BE', zone:'BE', live:false, currency:'EUR', timezone:'Europe/Brussels', vatPct:21, addersEurPerKwh:0, name:{en:'Belgium',lv:'Beļģija',lt:'Belgija',ee:'Belgia',ru:'Бельгия'}, flag:'🇧🇪', lang:'en' },
  at: { country:'AT', zone:'AT', live:false, currency:'EUR', timezone:'Europe/Vienna', vatPct:20, addersEurPerKwh:0, name:{en:'Austria',lv:'Austrija',lt:'Austrija',ee:'Austria',ru:'Австрия'}, flag:'🇦🇹', lang:'en' },
  fr: { country:'FR', zone:'FR', live:false, currency:'EUR', timezone:'Europe/Paris', vatPct:20, addersEurPerKwh:0, name:{en:'France',lv:'Francija',lt:'Prancūzija',ee:'Prantsusmaa',ru:'Франция'}, flag:'🇫🇷', lang:'en' },
  pl: { country:'PL', zone:'PL', live:false, currency:'PLN', timezone:'Europe/Warsaw', vatPct:23, addersEurPerKwh:0, name:{en:'Poland',lv:'Polija',lt:'Lenkija',ee:'Poola',ru:'Польша'}, flag:'🇵🇱', lang:'en' },
...
function normalizeArea(area){ const key = String(area || 'lv').toLowerCase().replace('-', '_'); return MARKETS[key] ? key : 'lv'; }
...
function apiPayload(rows, url, hist90 = [], hist365 = []){
  ...
  return { ok:true, source:'Elering / Nord Pool regional electricity prices', sourceUrl:SOURCE, updatedAt:new Date().toISOString(), timezone:MARKETS[area].timezone, intervalMinutes:15, area, market: MARKETS[area], markets: MARKETS, opts, benchmarks: buildBenchmark(s.current, hist90, hist365, MARKETS[area].timezone), ...s };
}
